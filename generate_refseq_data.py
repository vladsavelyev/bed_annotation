...
from Utils.bam_bed_utils import bgzip_and_tabix
...
See more info in http://wiki.rd.astrazeneca.net/display/NG/SOP+-+Making+the+full+list+of+UCSC+exons+with+approved+HUGO+gene+symbols'''
    ...
    all_features_fpath = ga.get_all_features_unzip(genome_name)
    ...
    canon_output_fpath = ga.get_all_features_canonical_unzip(genome_name)
